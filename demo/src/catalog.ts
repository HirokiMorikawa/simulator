  ...
  },
  {
    ...
    experiments: [
      ...
      },
      {
        ...
        watch: [
          "空気があると、鉄の球のほうが先に地面へ近づき、木の球はまだ高い"
            + "ところにいます——右の「いまの数値」で、2つの高さがみるみる"
            + "離れていきます(右上の「画面の詳しさ」を右へ動かすと、下のグラフでも2本の線が"
            + "分かれるのが見えます)。",
          "「重い物のほうが速く落ちる」と感じるのはこのため——正体は重さの差ではなく、"
            + "空気の抵抗の差です(軽い球ほど、同じ速さでも空気に強くブレーキをかけられます)。",
          "空気を「なし」にすると、重さが15倍以上違っても、地面に着くまでは2つの球の高さが"
            + "ぴったり重なって進みます(右上の「画面の詳しさ」を右へ動かしてグラフを出すと、2本の線が"
            + "1本に見えるほど重なります)。実測: 空気ありは着地に約 0.6 秒の差、"
            + "空気なしは差ゼロ。(着地したあとの跳ね返り方は2つでちがいますが、"
            + "それは重さではなく材質のちがいです——はね返りやすさが鋼は0.6、"
            + "木材(松)は0.4。落ちる話とは別の話です。)",
