...
//! 空力加熱・アブレーション・レジーム切替は未実装)・`perturbations`($J_2$扁平率摂動、
//! 同docs §2.2)を実装。Barnes-Hut・WHFast・浮動原点・軌道力学(ホーマン遷移以外)の
//! 型・トレイトのスケルトンは Phase A で追加する(docs/22-roadmap/01-phases.md)。
