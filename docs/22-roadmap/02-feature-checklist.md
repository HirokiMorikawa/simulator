...
**カウント(本増分後の実測値)**: チェックボックス総数 **262** / 済 **219** / 未 **43**
(完了率 83.6%)。節別内訳:
...
| §6 フロントエンド | — | — | 9 | Console連動、Inspector Component、Hierarchy未接続ドメイン、Toolbarシーン選択、Circuit-focusレイアウト等。**Probe対数軸/CSVは増分E1で完了** |
