...
- **作業中**: なし(直前の増分でP1が完了、次点候補から自由に選択)。
  次点候補: フル RayTracer(sim-em 残り)、GJK/EPA・フルCCD(Phase 5)、FDTD(E8/E13)、
  イジングL=256フル版(長時間級)、WCSPH・車両(P4残り)
...
- [x] 担当テスト Green: E1–E7, E9–E12, F10, S4–S6, T8(E1・E2・E3–E5・E6・E7・E9–E12・
      S4・S5・S6 Green)
