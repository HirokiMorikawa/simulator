...
| **P1** 力学基礎 | 剛体・総当たり衝突・接触ソルバ・最小 CCD(speculative contact、C-5)・摩擦・重力・抗力・浮力・熱ノード・台帳 | M1–M9,M12,M15, F1–F6, T1,T2 |
...
| **P4** 電磁・光・SPH・車両・ブラウン | 回路・モーター・静場・光学・WCSPH・車両・ランジュバン・エンティティ受け入れ(関節 PD 静的姿勢維持、[20-integration/03](../20-integration/03-entity-layer.md) §7) | E1–E7,E9–E12, F10, S4–S6, T8 |
...
バランス制御(立位保持・外乱復元 — P4 完了条件からはスコープ外へ移設)・歩行制御・飛行機・
熱機関(オットー)・FLIP 流体・DFSPH・音響・地形(高さ場)・
